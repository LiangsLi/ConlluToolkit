...
with open("data/coarse2fine.json", encoding="utf-8") as f:
...
def main():
    ...
    parser.add_argument(
        "-i", "--input", help="输入细粒度conllu文件", default="fine_text.test.cor.sdp.conllu"
    )
    parser.add_argument(
        "-o", "--output", help="输出粗粒度conllu文件", default="text.test.coarse.conllu"
    )
